...
def fetching_pdf(pdf,chunk_size,chunk_overlap):
    text = ''
    for f in pdf:
...
#-------------------------------------------------------------------
    ...
    if pdf:
        ...
        user_question = st.chat_input("Ask a question about your PDF. You can use [] to narrow the dataset search.")
